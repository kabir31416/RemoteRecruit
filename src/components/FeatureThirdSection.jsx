            ...
            <div className="max-w-[1240px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                ...
                <div className="lg:col-span-7 relative w-full flex justify-center lg:justify-end py-10">
                    ...
                    <div className="relative w-[340px] md:w-[380px] bg-white rounded-[32px] 
                        ...
                        <div className="flex flex-wrap gap-2 p-3 rounded-3xl mb-3">
                            {skills.map((skill, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-1.5 text-xs font-medium text-[#1b4393] bg-[#edf5ff] rounded-full"
                                >
                                    {skill}
                                </span>
                            ))}

                            <span className="px-3 py-1.5 text-xs font-medium text-[#1b4393] bg-[#edf5ff] rounded-full">
                                +12
                            </span>
                        </div>
                    </div>
                    ...
                    {/* 1st card */}
                    <div className="absolute top-[50%] left-[5%] md:left-[15%] lg:left-[30%] mb-5 w-[280px] md:w-[280px] bg-white/95 backdrop-blur-sm rounded-full p-2.5 shadow-[0_15px_35px_-5px_rgba(0,0,0,0.1)] border border-slate-100 flex items-center gap-4 z-20 transition-transform hover:-translate-y-1 duration-300">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[11px] font-semibold text-[#1b4393]">Past Client Feedback</span>
                            <span className="text-[15px] font-bold text-slate-800 tracking-tight">Best Developer Ever!</span>
                        </div>
                    </div>


                    {/* logo badge */}
                    <div className="absolute top-[32%] right-[2%] md:right-[15%] lg:right-[-3%] w-16 h-16 md:w-15 md:h-15 bg-gradient-to-br from-[#2a62cc] to-[#143475] rounded-full flex items-center justify-center shadow-[0_12px_28px_rgba(27,67,147,0.3)] border-2 border-blue-400/20 z-20 transition-transform hover:scale-105 duration-300">

                        <img
                            src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80"
                            alt="Felonious Gru"
                            className="w-full h-full object-cover rounded-full bg-slate-100 m-px"
                        />
